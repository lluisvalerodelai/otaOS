...
;IRQ management
;we need to remap PIC and PIC2 to not interfere with the IDT
global irq0
global irq1
global irq2
global irq3
...
; so we need to remap IRQ0-15 to IDT entires 32-37
irq0:   ; but really this is irq32 :)
	cli
	push byte 0
	push byte 32
	jmp irq_common_stub

irq1:   ; IRQ 33 but actually 1 and so on
    cli
    push byte 0
    push byte 33
    jmp irq_common_stub
