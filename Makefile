...
build/multiboot_header.o: bootHeader/multiboot_header.asm
	mkdir -p build
	nasm -f elf32 bootHeader/multiboot_header.asm -o build/multiboot_header.o

build/boot.o: setup/boot.asm
	mkdir -p build
	nasm -f elf32 setup/boot.asm -o build/boot.o
